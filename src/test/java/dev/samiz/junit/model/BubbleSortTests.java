...
public class BubbleSortTests {
    ...
    @Test
    @DisplayName("Given an array of ints the BubbleSort class returns the array sorted")
    ...
    @Test
    @DisplayName("Given an array of only 1 int element the BubbleSort class returns the array \"sorted\"")
    ...
    @Test
    @DisplayName("Given an array of duplicate ints the BubbleSort class returns the array \"sorted\"")
    ...
    @Test
    @DisplayName("Given an array of duplicate ints bar one the BubbleSort class returns the array sorted")
    ...
    @Test
    @DisplayName("Given an array of negative ints the BubbleSort class returns the array sorted")
    ...
    @Test
    @DisplayName("Given an array of positive and negative ints the BubbleSort class returns the array sorted")
    ...
    @Test
    @DisplayName("Given an array containing no ints the BubbleSort class returns the empty array")
    ...
    @Test
    @DisplayName("Given an array which is null the BubbleSort class is expected to throw a \"NullPointerException\"")
    ...
    @Test
    @DisplayName("Given an array of 10 ints with RNG bounds for values the BubbleSort class returns the array sorted")
    ...
    @Test
    @DisplayName("Given an array with a random length containing random ints the BubbleSort class returns the array sorted")
