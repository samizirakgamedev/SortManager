...
public class BubbleSortTests {
    ...
    private static SortManagerController controller;
    ...
    @BeforeAll
    static  void setUp(){ controller = new SortManagerController();}
    ...
    public void bubbleSortWorksStandard(){
        ...
        int[] result = controller.initiateSort("bubble",unsorted);
    ...
    public void bubbleSortWithNullArray(){
        int[] unsorted = null;
        NullPointerException nullPointerException = Assertions.assertThrows(NullPointerException.class, () -> controller.initiateSort("bubble",unsorted),"An exception has not been thrown");
    }
    @Test
    ...
    public void bubbleSortWithRandomValues() {
        ...
        int[] unsorted = controller.generateRandomArray(length, randValueBounds);
    ...
    public void bubbleSortWithRandomArraySize() {
        ...
        int randValueBounds = Math.abs(rand.nextInt());
        // Generate the array and make a copy of it.
        int[] unsorted = controller.generateRandomArray(randLength, randValueBounds);
